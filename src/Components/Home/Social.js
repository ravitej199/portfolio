...
const Social = () => {
  return (
    <div className='home_social'>
        <a href="https://github.com/ravitej199" className='home_social-icon' rel="noopener"target='_blank'>
        <i className="uil uil-github"></i>
      
        </a>
        <a href="https://www.linkedin.com/in/ravitej-herwatta-b2a6841a5" rel="noopener" className='home_social-icon' target='_blank'>
        <i className="uil uil-linkedin-alt"></i>
       
        </a>
        <a href="https://www.hackerrank.com/profile/ravitejravi90" rel="noopener" className='home_social-icon' target='_blank'>
        <i className="uil">
